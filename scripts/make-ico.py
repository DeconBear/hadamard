#!/usr/bin/env python3
"""Generate a multi-resolution Windows .ico from assets/hadamard-icon.png.
...
Writes: assets/hadamard-icon.ico
"""
...
SRC = ROOT / "assets" / "hadamard-icon.png"
OUT = ROOT / "assets" / "hadamard-icon.ico"
