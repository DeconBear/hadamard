...
import { buildCodeActEnvironment, resolveCodeActSettings } from './codeActPolicy.js';
...
export class ProgrammaticToolRuntime {
  ...
  async run(input: {
    ...
    if (!this.settings.enabled) {
      throw new HadamardSdkError('The PTC program runtime is disabled.', 'PTC_DISABLED');
    }
