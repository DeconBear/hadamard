...
/**
 * Browser-side copies of splitGitStatus / buildPathTree / gitStatusBadge for
 * /app.js. Kept next to the TypeScript implementations above so the two stay
 * aligned (Function#toString is unsafe under tsx because of type annotations).
 */
export function getProjectWorkbenchClientHelpers(): string {
  return `
