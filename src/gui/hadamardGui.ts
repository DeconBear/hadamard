...
// (dist/src/gui/hadamardGui.js → ../../../assets/xterm/) and in the packaged
...
export async function startHadamardGuiServer(options: HadamardGuiOptions = {}): Promise<HadamardGuiServer> {
  ...
  const server = createServer(async (req, res) => {
    try {
      ...
      if (req.method === 'GET' && url.pathname === '/app.css') return text(res, 200, createHadamardGuiStyles(), 'text/css');
      if (req.method === 'GET' && url.pathname === '/app.js') return text(res, 200, createHadamardGuiClientScript(), 'text/javascript');
