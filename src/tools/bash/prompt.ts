...
- When stopping a server you started, kill its specific PID — never \`taskkill /IM node.exe\`, \`killall node\`, or \`Stop-Process -Name node\` (those terminate Hadamard itself).
- For git commands:
