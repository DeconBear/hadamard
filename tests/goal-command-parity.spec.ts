  ...
  it('keeps TUI and GUI wired to the same ProjectGoalApi command method', async () => {
    const [tui, gui] = await Promise.all([
      Promise.all([
        ...
        readFile(path.resolve('src/tui/tuiRuntimeLifecycle.ts'), 'utf8'),
        ...
        readFile(path.resolve('src/tui/tuiBasicCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiPlanCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiSessionCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiWorkflowCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiWorktreeCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiBridgeCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiTeamCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiIssueCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiAssistantCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiManagerCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiWorkspaceCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiContextCommandHandler.ts'), 'utf8'),
        readFile(path.resolve('src/tui/tuiCatalogCommandHandler.ts'), 'utf8'),
      ...
      Promise.all([
        ...
        readFile(path.resolve('src/gui/guiAgentHttpController.ts'), 'utf8'),
      ]).then(parts => parts.join('\n')),
    ]);
