...
function readGuiSources(root: string): string {
  return [
    readFileSync(join(root, 'src', 'gui', 'hadamardGui.ts'), 'utf8'),
    ...
    readFileSync(join(root, 'src', 'gui', 'guiTeamHttpController.ts'), 'utf8'),
    readFileSync(join(root, 'src', 'gui', 'guiAgentHttpController.ts'), 'utf8'),
  ].join('\n');
}
...
function readTuiSources(root: string): string {
  return [
    ...
    readFileSync(join(root, 'src', 'tui', 'tuiConfigurationCommandHandler.ts'), 'utf8'),
    readFileSync(join(root, 'src', 'tui', 'tuiBasicCommandHandler.ts'), 'utf8'),
    ...
    readFileSync(join(root, 'src', 'tui', 'tuiTeamCommandHandler.ts'), 'utf8'),
    readFileSync(join(root, 'src', 'tui', 'tuiIssueCommandHandler.ts'), 'utf8'),
    readFileSync(join(root, 'src', 'tui', 'tuiAssistantCommandHandler.ts'), 'utf8'),
    readFileSync(join(root, 'src', 'tui', 'tuiManagerCommandHandler.ts'), 'utf8'),
...
describe('TUI and GUI parity', () => {
  ...
  it('renders GUI shell controls for the interactive surface', () => {
    ...
    expect(html).not.toContain('id="settingsApiKey"');
    expect(html).toContain('id="defaultModelOnboarding"');
    expect(html).toContain('id="onboardingApiKey"');
    expect(html).toContain('id="onboardingBaseUrl"');
    expect(html).toContain('id="onboardingModel"');
    expect(html).toContain('id="onboardingEffort"');
    expect(html).toContain('id="onboardingContext1M"');
    expect(html).toContain('id="onboardingMultimodal"');
    ...
    expect(html).not.toContain('id="settingsRouterStatus"');
    expect(html).not.toContain('id="settingsDisableRouter"');
    ...
    expect(html).toContain('id="bridgeNewModelContextWindow"');
    expect(html).not.toContain('id="bridgeNewModel1M"');
    expect(html).toContain('<h1>Models</h1>');
    ...
    expect(html).not.toContain('data-settings-panel="profile"');
    expect(html).not.toContain('data-settings-tab="env"');
    expect(html).not.toContain('data-settings-panel="env"');
    ...
    expect(gui).toContain('id="settingsWindowsTerminalShell"');
    ...
    expect(html).toContain('id="settingsShowAgentProfilesInComposer"');
    expect(html).toContain('id="settingsShowRouterProfilesInComposer"');
    expect(html).not.toContain('<h2>Default model</h2>');
    expect(html).toContain('<h2>Configs</h2>');
    expect(html).not.toContain('id="settingsMinModel"');
    expect(html).not.toContain('id="settingsMediumModel"');
    expect(html).not.toContain('id="settingsMaxModel"');
    expect(html).toContain('id="bridgeDefaultEffortField"');
    ...
    expect(js).toContain('showRouterProfilesInComposer');
    expect(js).toContain('syncDefaultModelOnboarding');
    ...
    expect(html).toContain('id="agentProfileAdvanced"');
    expect(html).toContain('id="agentProfileTopP"');
